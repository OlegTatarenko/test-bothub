...
Разработать простого Telegram-бота с использованием PHP и MySQL либо PostgreSQL. Нельзя использовать фреймворки и ORM. Можно использовать composer и сторонние обёртки для Telegram-API.
